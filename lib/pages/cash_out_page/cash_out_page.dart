...
import 'package:two_d/pages/cash_out_page/cash_out_detail.dart';
  ...
  Widget bankWidget(BankModel bankModel, BuildContext context) {
    return Container(
      decoration: const BoxDecoration(
        ...
        border: Border(
          left: BorderSide(color: AppColor.greenBlack, width: 10),
        ),
      ),
      child: ListTile(
        onTap: () {
          context.go(CashoutDetail(bankModel: bankModel));
        },
        isThreeLine: true,

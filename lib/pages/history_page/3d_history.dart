...
class ThreeDHistoryPage extends StatefulWidget {
  const ThreeDHistoryPage({super.key});

  @override
  State<ThreeDHistoryPage> createState() => _ThreeDHistoryPageState();
}

class _ThreeDHistoryPageState extends State<ThreeDHistoryPage> {
  ...
  void getData() {
    BlocProvider.of<HistoryBlocBloc>(context)
        .add(const TapHistoryEvent(gameType: "3D"));
  }
  ...
  Widget listVbuilder(Size size) {
    return SmartRefresher(
      ...
      onLoading: () {
        BlocProvider.of<HistoryBlocBloc>(context)
            .add(const TapHistoryMoreEvent(gameType: "3D"));
      },
